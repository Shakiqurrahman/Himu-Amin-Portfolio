...
const Header = () => {
    ...
    return (
        <header className={`${color ? "text-white bg-white sm:bg-transparent" : "bg-white text-black duration-300"} fixed top-0 z-50 mx-auto w-full`}>
            ...
            <h1 className='sm:text-xl text-sm font-bold sm:text-inherit text-black font-mono'>Himu <span>Amin</span></h1>
            </div>
            <nav>
                ...
                <div onClick={() => {setIsActive(!isActive)}} className='hamburger md:hidden'>
